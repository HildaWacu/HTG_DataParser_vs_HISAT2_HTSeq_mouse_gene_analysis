...
SECONDS=0
echo  "Performing read quantification using HTSeq - read_quant_htseq_samout_intersection-nonempty.sh"
...
external_drive_path_htseq="/mnt/d/FASTQ_files/HTSeq/counts_samout_intersection-empty"
