...
# dotplot(goSEA)
# 
cnetplot(goSEA_HTseq, colorEdge = TRUE, cex_label_gene = 0.5)
dotplot(goSEA_HTseq)
...
# cnetplot(goSEA_HTG, colorEdge = T, cex_label_gene = 0.5)
# dotplot(goSEA_HTG)
...
```{r}
results1 <- data.frame(top10pathways_HTG=results_goSEA_HTG[,1],top10pathways_HTSeq=results_goSEA_HTseq[,1])
results1
...
```{r}
results2 <- data.frame(top10pathways_HTG=results_goSEA_HTG[,1],top10pathways_HTSeq=results_goSEA_HTseq[,1])
results2
