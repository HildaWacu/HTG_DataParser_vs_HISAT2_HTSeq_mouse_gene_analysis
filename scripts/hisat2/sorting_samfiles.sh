...
SECONDS=0
## Run samtools to sort the .sam files and convert them to .bam
external_drive_path_hisat2="/media/user/HildaWN/FASTQ_files/HISAT_alignment/results/aligned_reads"
mkdir $external_drive_path_hisat2/sorted_bam

cd $external_drive_path_hisat2/sorted_bam
# echo `pwd`
...
do
    ...
    samtools sort -O BAM -o "$prefix"_sorted.bam $i
done
